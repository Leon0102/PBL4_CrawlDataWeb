...
public class UPCOM_Controller {
	public static void handle() throws JSONException, IOException {
	    JSONArray json1 = JsonReader.readJsonFromUrlArr("https://banggia.cafef.vn/stockhandler.ashx?center=9");
	    ObjectMapper mapper = new ObjectMapper();
	    try {
	    	UPCOM_DAO db = new UPCOM_DAO();
	    	ArrayList<UPCOM> listck = new ArrayList<>();
