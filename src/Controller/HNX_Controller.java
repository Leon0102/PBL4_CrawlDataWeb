...
public class HNX_Controller {
	public static void handle() throws JSONException, IOException {
	    JSONArray json1 = JsonReader.readJsonFromUrlArr("https://banggia.cafef.vn/stockhandler.ashx?center=2");
	    ObjectMapper mapper = new ObjectMapper();
	    try {
	    	HNX_DAO db = new HNX_DAO();
	    	ArrayList<HNX> listck = new ArrayList<>();
